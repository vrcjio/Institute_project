...
function PermanentEnquiryForm({setShow}) {
  ...
  return (
    <Form onSubmit={checkAndSend}>
      ...
      <Form.Group className="mb-3" controlId="formBasicNumber">
        ...
        <Form.Control onChange={checkAndSend} value={user.contact} type="number" name="contact" minLength={1000000000} maxLength={99999999999} placeholder="Enter Number" required/>
...
export default PermanentEnquiryForm;